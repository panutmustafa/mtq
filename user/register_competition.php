...
// Ambil pengumuman aktif (not needed for this page, but keeping for consistency if other elements require it)
...
<head>
    ...
    <title>Form Pendaftaran Lomba | Sistem Penilaian Lomba</title>
    ...
    <div class="sidebar d-none d-md-block">
        <ul class="nav flex-column">
            <li class="nav-item">
          	...
          	<li class="nav-item">
                <a class="nav-link active" href="register_competition.php"><i class="fas fa-pencil-alt"></i> Daftar Lomba</a>
            </li>
            <li class="nav-item">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-pencil-alt"></i> Form Pendaftaran Lomba
                        </div>
                        <div class="card-body">
